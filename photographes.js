...
// var json =fetch('FishEyeData.json')
// .then(function(res) {
//   if (res.ok) {
//     return res.json();
//   }
...
function getMedia (photographerId) {
    if (photographerId === undefined) {
      console.log(obj.media[3].likes);
        //return obj.media;
    }

    else {
      let myMedia = false;
      obj.media.forEach(function(medias){
          if (medias.id === photographerId) {
              console.log("TATA");
              myMedia = medias;
          }
      })
...
const myMedias = getMedia();
//console.log(obj.media);

//  function photographeMedia (medias) {
//     if (medias.id === photographerId)  {
//          console.log("TOTO");
//       console.log(obj.media);
//     }
...
function onePhotographe(id) {
  if(urlId === undefined ) {
    console.log("BBBBBB");
  }
  else {
    obj.photographers.forEach(function(photographes){
                if (photographes.id === urlId) {
                  console.log("TATA");
                  //photographe = photographes;
              }
           })
    ...
    var myHtml = `
      <a href="photographes.html?id=${photographes.id}">
        <section class="photographe-heading">
            ...
            <div>
                <img src="FishEye_Photos/Sample Photos/Photographers ID Photos/${photographes.portrait}" alt="" class="heading-photo">
            </div>
        </section>
        ...
        <section class="photographe-galerie">    
            ...
            <section class="photographe-medias">
              <div class="photographe-medias__lightbox">
                <a href="">
                    <img src="FishEye_Photos/Sample Photos/Mimi/Animals_Rainbow.jpg" alt="" class="photographe-medias__lightbox--img"/>
                </a>
